    ...
    describe( '#generateSettings()', function () {
        ...
        it( 'should merge the mirror secret variable into the mirror declarations', function () {
            ...
            try {
                generateSettings();
                assert.strictEqual( readSettingsFile(),
                    getSettingsXML( '<mirrors><mirror><id>central-proxy</id><name>Central Proxy</name><mirrorOf>central</mirrorOf><url>https://repo.sytm.de/repository/maven-central/</url></mirror><mirror><id>sonatype-proxy</id><name>Sonatype Proxy</name><mirrorOf>sonatype</mirrorOf><url>https://repo.sytm.de/repository/maven-sonatype/</url></mirror></mirrors>' ) )
            } finally {
                restore();
                deleteSettingsFile();
            }
